...
<form action="${pageContext.request.contextPath}/newsperson/login" method="post" onsubmit="return checkForm()">
    <DIV style="background: rgb(255, 255, 255); margin: -100px auto auto; border: 1px solid rgb(231, 231, 231); border-image: none; width: 400px; height: 200px; text-align: center;">
        ...
        <P style="padding: 30px 0px 10px; position: relative;">
            ...
            <INPUT id="name" name="name" class="ipt" type="text" placeholder="请输入用户名" value="">
        </P>
        <P style="position: relative;">
            <SPAN class="p_logo"></SPAN>
            <INPUT id="password" name="password" class="ipt"  type="password" placeholder="请输入密码" value="${newsperson.password }">
            <br><span style="color: red">${msg}</span>
        </P>
        <DIV style="height: 50px; line-height: 34px; margin-top: 30px; border-top-color: rgb(231, 231, 231); border-top-width: 1px; border-top-style: solid;">
            <P style="margin: 0px 35px 20px 45px;">
                ...
                <SPAN style="margin-right:-200px;">
                    <a href="${pageContext.request.contextPath}/register.jsp" type="submit" style="background: rgb(0, 142, 173); padding: 8px 11px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;">注册</a>
	         </SPAN>
            </P>
        </DIV>
    </DIV>
