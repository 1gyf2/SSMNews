...
public class NewspersonAdminController {
	...
	@RequestMapping("/save")
	public String save(@RequestParam("imageFile") MultipartFile imageFile, Newsperson newsperson, Model model, BindingResult br, HttpServletRequest request, HttpServletResponse response)throws Exception{
