...
<div class="data_list">
	<div class="data_list_title">
		<img src="${pageContext.request.contextPath}/static/images/news_show_icon.png"/>
		新闻信息
	</div>
	<div>
	   <div class="news_title"><h3><strong>${news.title }</strong></h3></div>
	   <div style="padding-left: 330px;padding-bottom: 20px;padding-top: 10px">
		<div class="bshare-custom">
			<a title="分享到QQ空间" class="bshare-qzone"></a>
			<a title="分享到新浪微博" class="bshare-sinamininews"></a>
		...
		<div class="news_info">
			发布时间：『 <fmt:formatDate value="${news.releaseDate }" type="date" pattern="yyyy-MM-dd HH:mm"/>』&nbsp;&nbsp;新闻类别：${news.newsType.typeName}&nbsp;&nbsp;阅读(${news.clickHit}) 评论(${news.replyHit})
		</div>
			...
			<c:choose>
				...
				<c:otherwise>
					<c:forEach var="keyWord" items="${keyWords }">
						&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/news/q.html?q=${keyWord}" target="_blank">${keyWord }</a>&nbsp;&nbsp;
					</c:forEach>
				</c:otherwise>
			</c:choose>
		</div>
