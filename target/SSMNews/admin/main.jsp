...
<script type="text/javascript">
	...
	function openPasswordModifyDialog(){
		...
		url="${pageContext.request.contextPath}/admin/newsperson/modifyPassword?id=${sessionScope.loginNewsperson.id}";
	}
	...
	function logout(){
		$.messager.confirm("系统提示","您确定要退出系统吗？",function(r){
			if(r){
				window.location.href='${pageContext.request.contextPath}/admin/newsperson/logout';
			}
		 });
	}
	function indexout(){
		$.messager.confirm("系统提示","您确定要退返回浏览页吗？",function(r){
			if(r){
	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<span style="font-size: small; ">&nbsp;&nbsp;<strong>欢迎：</strong>${sessionScope.loginNewsperson.name }</span>
				<a href="javascript:indexout()" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-exit'" style="width: 150px;">返回浏览页</a>
			</td>
		</tr>
	</table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
	<div class="easyui-accordion" data-options="fit:true,border:false">
		<div title="常用操作" data-options="selected:true,iconCls:'icon-item'" style="padding: 10px">
			<a href="javascript:openTab('写新闻','writeNews.jsp','icon-writenews')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px">写新闻</a>
		...
		<div title="新闻管理"  data-options="iconCls:'icon-bkgl'" style="padding:10px;">
			<a href="javascript:openTab('写新闻','writeNews.jsp','icon-writenews')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-writenews'" style="width: 150px;">写新闻</a>
			<a href="javascript:openTab('新闻信息管理','newsManage.jsp','icon-bkgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bkgl'" style="width: 150px;">新闻信息管理</a>
		</div>
		<div title="新闻类别管理" data-options="iconCls:'icon-bklb'" style="padding:10px">
			<a href="javascript:openTab('新闻类别信息管理','newsTypeManage.jsp','icon-bklb')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-bklb'" style="width: 150px;">新闻类别信息管理</a>
		</div>
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:200px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		<tr>
   			<td>用户名：</td>
   			<td><input type="text" id="userName" name="name" readonly="readonly" value="${sessionScope.loginNewsperson.name }" style="width: 200px"/></td>
   		</tr>
   		<tr>
   			<td>新密码：</td>
